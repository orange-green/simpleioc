package com.orangegreen.ioc.xml;

import com.orangegreen.ioc.bean.AbstractBeanDefinitionReader;
...
import com.orangegreen.ioc.io.ResourceURL;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
     ...
     * xml文件读取
     */
    public void XMLReader(String location) throws Exception {
        // 获取xml文件的输入流
        ResourceLoader resourceLoader = new ResourceLoader();
        ResourceURL resourceURL = resourceLoader.getResourceURL(location);
